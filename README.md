...
- myorep-timer — high-precision React/TypeScript workout timer built for Myo-rep training with worker-based timing, voice cues, and PiP-friendly session flow ([app](https://myorep-timer.vercel.app))
